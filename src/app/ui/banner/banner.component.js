...
export default connect(mapStateToProps)(
  class Banner extends React.Component {
    ...
    render() {
          ...
          <div className="banner-wrapper">
            ...
            <div className="banner-ui">
              ...
              <div className="banner-switcher">
                ...
                <i>
                  <span>{curBannerNumber}</span>/{bannerLength}
                </i>{' '}
                {/* button clicks should fire event that will select other banners */}
                <button className="clickable">
      ...
      return (
        <section className="wan-banner-container">{bannerTemplate}</section>
      );
    }
  },
);
